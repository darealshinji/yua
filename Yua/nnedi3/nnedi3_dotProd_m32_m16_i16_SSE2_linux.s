	.text
.globl dotProd_m32_m16_i16_SSE2
dotProd_m32_m16_i16_SSE2:
LFB2:
	pushq	%rbp
LCFI0:
	movq	%rsp, %rbp
...
LCFI2:
	...
	movq	%r9, -56(%rbp)
	# top of block
	.file "nnedi3dotProd_m32_m16_i16_SSE2.c"
	.line 4
	push %rbx
	.file "nnedi3dotProd_m32_m16_i16_SSE2.c"
	.line 6
...
LSCIE1:
	...
	.align 16
LECIE1:
.globl dotProd_m32_m16_i16_SSE2.eh
dotProd_m32_m16_i16_SSE2.eh:
LSFDE1:
