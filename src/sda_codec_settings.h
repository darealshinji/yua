...
#define IQ_AUDIO_BITRATE XQ_AUDIO_BITRATE //320kb/s
#define HQ_AUDIO_BITRATE 128000 //128kb/s
#define MQ_AUDIO_BITRATE 64000 //64kb/s
#define LQ_AUDIO_BITRATE MQ_AUDIO_BITRATE //64kb/s

#define AUDIO_COMMENTARY_BITRATE_SETTING "32k" //32kb/s

#define MQ_MAX_FRAMERATE 35 //changed from 31 due to an ff7 run (20131214)

#define D4_NATIVE_WIDTH 320
#define D4_NATIVE_HEIGHT 240
#define LQ_HEIGHT D4_NATIVE_HEIGHT //240
#define MQ_HEIGHT D4_NATIVE_HEIGHT //240
#define D1_NATIVE_WIDTH 640
#define D1_NATIVE_HEIGHT 480
#define HQ_HEIGHT D1_NATIVE_HEIGHT //480
